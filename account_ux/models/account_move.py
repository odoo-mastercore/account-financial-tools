...
class AccountMove(models.Model):
    ...
    #Se comento todo este bloque porque nos interesa que en el widget de concilicacion
    # de la factura se previsualice con el cambio en usd correspondiente y en
    # las facturas que tienen como moneda base usd se visualiza un monto diferente
    # pues toma el monto de la compañia como rate.
    #TODO: chequear de que otra forma se peude mantener este cambio.
